...
const getDatabase = async () => {
    if (!pool) {
        pool = await (0, exports.initializeConnection)();
    }
    return pool;
};
    ...
    try {
        ...
        if (categoriesCount === 0) {
            ...
            for (const category of categories) {
                await client.query('INSERT INTO assessment_categories (name, description, weight, order_index) VALUES ($1, $2, $3, $4)', [category.name, category.description, category.weight, category.order_index]);
            }
            await client.query('INSERT INTO assessment_templates (name, version, description) VALUES ($1, $2, $3)', ['Default VC Readiness Assessment', '1.0', 'Comprehensive assessment for VC funding readiness']);
